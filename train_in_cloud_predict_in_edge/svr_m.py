...
# opt_x, opt_y = opt(lgb, max_iters=2, train_x=x_train, train_y=y_train, cv_mun=10, init_start=5, model_score='neg_mean_squared_error', print_opt=True)
# lgb_f = lgb.f(opt_x)
lgb_f = SVR(kernel='rbf', gamma=0.0002, C=1500)
